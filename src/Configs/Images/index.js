...
export const IMAGES = [
  ...
  { image: DELHI_POLICE, alt: "DELHI_POLICE" },
  { image: ASSAM_POLICE, alt: "ASSAM_POLICE" },
  { image: AIR_FORCE, alt: "AIR_FORCE" },
  { image: JKL, alt: "JKL" },
  { image: HP, alt: "HP" },
  { image: INDIAN_ARMY, alt: "INDIAN_ARMY" },
  { image: JHARKHAND, alt: "JHARKHAND" },
  { image: UK, alt: "UK" },
  { image: LAW, alt: "LAW" },
  { image: BLUE_NETWORK, alt: "BLUE_NETWORK" },
  { image: ATNIS, alt: "ATNIS" },
  { image: ENSTAL, alt: "ENSTAL" },
  { image: GLOBAL_XPERT, alt: "GLOBAL_XPERT" },
  { image: GUARIDAN, alt: "GUARIDAN" },
  { image: HYPER_SHIFT, alt: "HYPER_SHIFT" },
  { image: LMQ, alt: "LMQ" },
  { image: MIDDLE_GROUND, alt: "MIDDLE_GROUND" },
  { image: TOUCH_BASE, alt: "TOUCH_BASE" },
  { image: PCNC, alt: "PCNC" },
  { image: INTRUM, alt: "INTRUM" },
  { image: ROYAL, alt: "ROYAL" },
  { image: CLOUD_REACH, alt: "CLOUD_REACH" },
  { image: GEAR_HOST, alt: "GEAR_HOST" },
  { image: FINAL_FRAME, alt: "FINAL_FRAME" },
  { image: VIRTUVENT, alt: "VIRTUVENT" },
  { image: WORLD_POSSIBLE, alt: "WORLD_POSSIBLE" },
  { image: VOIPED, alt: "VOIPED" },
  { image: WELCOME, alt: "WELCOME" },
  { image: STAR_DATA, alt: "STAR_DATA" },
  { image: VGC, alt: "VGC" },
  { image: KAILASH_HOSPITAL, alt: "KAILASH_HOSPITAL" },
  { image: JOHN_JAY, alt: "JOHN_JAY" },
  { image: UROLOGY, alt: "UROLOGY" },
  { image: BEST_WESTERN, alt: "BEST_WESTERN" },
  { image: IHG, alt: "IHG" },
  { image: OYO, alt: "OYO" },
  { image: LC, alt: "LC" },
  { image: SPAR, alt: "SPAR" },
  { image: SEVEN_Eleven, alt: "SEVEN_Eleven" },
  { image: GRANITIZE, alt: "GRANITIZE" },
  { image: BALARAMPUR_CHINI_MILL, alt: "BALARAMPUR_CHINI_MILL" },
  { image: COLOR, alt: "COLOR" },
];
